...
% Converts forces and moments which stem from the weight force from the NED
% frame to the BF frame, where g = 9.80665 [m/s^2] is the accel. of gravity
...
%%
% Mapeando os limites de saturação SE NECESSÁRIO
% Sim.F(:,j) = Mapeando(Sim.F(:,j));

% Total net forces and moments
